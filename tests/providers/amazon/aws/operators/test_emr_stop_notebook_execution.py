...
from airflow.providers.amazon.aws.operators.emr_stop_notebook_execution import EmrStopNotebookExecutionOperator
    ...
    def test_execute_stop_notebook_execution_and_does_not_error(self):
        with patch('boto3.session.Session', self.boto3_session_mock):
            operator = EmrStopNotebookExecutionOperator(
                task_id='test_task', notebook_execution_id='e-MYDEMONOTEBOOKZBCDEFG', aws_conn_id='aws_default'
            )
