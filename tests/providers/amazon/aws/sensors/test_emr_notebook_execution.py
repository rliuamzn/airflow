...
DESCRIBE_NOTEBOOK_EXECUTION_RUNNING_RETURN = {
    ...
    "NotebookExecution": {
        ...
        "Arn": "arn:aws:elasticmapreduce:us-east-1:123456789012:notebook-execution/ex-IZZX0PTECXPX4UJV0YVE8M7UUSLR5",
...
DESCRIBE_NOTEBOOK_EXECUTION_FINISHED_RETURN = {
    ...
    "NotebookExecution": {
        ...
        "EndTime": 1621969365.824,
        "Arn": "arn:aws:elasticmapreduce:us-east-1:123456789012:notebook-execution/ex-IZZX0PTECXPX4UJV0YVE8M7UUSLR5",
        "OutputNotebookURI": "s3://my-test-bucket/test-folder/e-2ZTI303F7CESD8BURE1Z9R3QS/executions/ex-IZZX0PTECXPX4UJV0YVE8M7UUSLR5/test.ipynb",
...
DESCRIBE_NOTEBOOK_EXECUTION_STOPPED_RETURN = {
    ...
    "NotebookExecution": {
        ...
        "Arn": "arn:aws:elasticmapreduce:us-east-1:123456789012:notebook-execution/ex-IZZX0PTECXPX4UJV0YVE8M7UUSLR5",
        "OutputNotebookURI": "s3://my-test-bucket/test-folder/e-5SB80N6HCVPKT0LPH64C1US0L/executions/ex-IZZX0PTECXPX4UJV0YVE8M7UUSLR5/test.ipynb",
...
DESCRIBE_NOTEBOOK_EXECUTION_FAILED_RETURN = {
    ...
    "NotebookExecution": {
        ...
        "Arn": "arn:aws:elasticmapreduce:us-east-1:123456789012:notebook-execution/ex-IZZX0PTECXPX4UJV0YVE8M7UUSLR5",
        "OutputNotebookURI": "s3://my-test-bucket/test-folder/e-89398BSPG8BYSV81UZFHHRQ15/executions/ex-IZZX0PTECXPX4UJV0YVE8M7UUSLR5/test.ipynb",
